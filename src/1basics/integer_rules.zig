...
// Integers by default are not allowed to overflow. Overflows are
// detectable illegal behaviour. Sometimes being able to overflow
// integers in a well defined manner is wanted behaviour.
